...
Datasets used for project:
    ...
    Cooperative Election Study Common Content, 2022
        ...
        The data file used in this project is a subset of columns (just the columns selected in the config), NOT the original full data set

       To access the full dataset: https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi%3A10.7910/DVN/PR4L8P
